  ...
  return (
    <div className="w-full fixed bottom-0 flex justify-center mb-8" >
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-full flex justify-center items-center w-3/4 max-w-sm h-16 px-4 z-50">
            {/** Resume Button */}
            <div className="w-1/2 h-2/3 flex justify-center items-center rounded-full bg-white text-deep-navy border-2 hover:border-hot-red transition duration-200">
                <a href="resume.pdf"
                   target="_blank"
                   rel="noopener noreferrer"
                   className="text-darker-navy font-semibold pr-2"
                >
                    Resume
                </a>
