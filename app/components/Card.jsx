...
const Card = ({ category, project, desc, techStack = [], img, site }) => {
  return (
        <div className='min-xxs:w-[270px] min-xs:w-[320px] bg-deep-navy backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden hover:border-white/20 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-white/10' >
