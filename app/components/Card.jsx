...
const Card = () => {
  return (
        ...
        <div className='w-sm bg-brand-primary-main/5 backdrop-blur-sm border border-black/10 rounded-3xl overflow-hidden hover:border-black/20 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-black/20' >
            ...
            {/** Project Image */}
            <div className="relative h-64 sm:h-72 lg:h-80 overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900">
                <img 
            ...
            <div className="px-6 sm:px-8 pb-6 sm:pb-8 -mt-8 relative z-10">
                <button 
                className="group/btn w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-[#0066FF] hover:bg-[#0052CC] text-white font-medium rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30"
                >
