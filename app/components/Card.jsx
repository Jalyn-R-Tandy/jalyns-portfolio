        ...
        <div className='w-sm bg-deep-navy backdrop-blur-sm border border-white/10 rounded-3xl overflow-hidden hover:border-white/20 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-black/20' >
            <div className="p-6 sm:p-8">
                ...
                <div className="flex items-start justify-between mb-4">
                    {/* Category Badge */}
                    <span className="px-3 py-1.5 bg-border-gray backdrop-blur-md border border-black/20 rounded-full text-xs font-medium text-medium-gray">
                        {category}
                    </span>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3 py-1 bg-white/5 border border-hot-red/20 rounded-lg text-xs font-medium text-hot-red transition-colors">{stack}</span>
            </div>
            {/** Project Image */}
