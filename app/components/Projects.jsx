...
const Projects = () => {
  return (
    <section id='projects' className="max-w-full h-max bg-darker-navy border border-white/20 rounded-3xl p-6 relative -top-12 before:content-[''] before:absolute before:top-[-12.5rem] before:left-[-12.5rem] before:w-80 before:h-80 before:rounded-full before:bg-hot-red/10 before:blur-3xl before:z-[-1] md:before:hidden">
